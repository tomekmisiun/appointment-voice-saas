...
7. Learning the repo or mentor-style explanations: `docs/project/current-state.md` +
...
Full workflow: **`docs/development/workflows/two-agent-review.md`**.
...
| Learn the codebase | `docs/project/current-state.md` |
...
Legacy foundation notes are archived under `docs/archive/legacy/`. They are
historical references only; current product documentation starts at
`docs/README.md`.
...
- New **workflow** → `.ai-rules/` + mention in `docs/development/workflows/ai-workflows.md`
...
Mechanical enforcement: `docs/development/ci-policy.md`.
