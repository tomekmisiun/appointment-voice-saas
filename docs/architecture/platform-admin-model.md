...
- `docs/architecture/tenant-isolation.md` — request boundaries and role summary
- `docs/operations/configuration.md` — environment and seed configuration
- `docs/operations/deployment.md` — production checklist and deployment boundaries
