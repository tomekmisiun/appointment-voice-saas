...
> See the current documentation: [`../../CURRENT_STATE.md`](../../project/current-state.md), [`../../ARCHITECTURE.md`](../../architecture/overview.md), and [`../../product/staff-access-calendar-roadmap.md`](../superseded/staff-access-calendar-roadmap.md).
...
- Executable epic: [Staff access and calendar roadmap](../superseded/staff-access-calendar-roadmap.md)
