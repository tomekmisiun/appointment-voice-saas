...
> See the current documentation: [`../../CURRENT_STATE.md`](../../project/current-state.md), [`../../../ROADMAP.md`](../../../ROADMAP.md), and [`../../../TECH_DEBT.md`](../../../TECH_DEBT.md).
...
- Read `docs/project/implementation-backlog.md` (all 52 P1–P4 rows + audit notes),
...
existing — is not; `docs/product/onboarding.md` still documents this
...
pointing to `PROJECT_STATUS.md` and `docs/project/implementation-backlog.md` as the
...
`README.md`, `ROADMAP.md`, `docs/project/implementation-backlog.md` audit-notes
