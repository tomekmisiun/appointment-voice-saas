> [!WARNING]
> This document is archived and does not describe the current active backlog.
> See the current documentation: [`../../appointment-saas-roadmap.md`](../../project/implementation-backlog.md), [`../../../ROADMAP.md`](../../../ROADMAP.md), and [`../../../TECH_DEBT.md`](../../../TECH_DEBT.md).
...
[`docs/archive/superseded/staff-access-calendar-roadmap.md`](../superseded/staff-access-calendar-roadmap.md).
...
6. ~~`feat/p3-008-pending-payment-state`~~ — **done** (P3-008 row above).
   ...
   payment-link flow must create the booking as `PENDING_PAYMENT` *before*
