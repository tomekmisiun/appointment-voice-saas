...
| Backend dependencies | **`docs/project/implementation-backlog.md` P2-013 (owner metrics API) — not implemented.** Do not start this task before it ships. |
| Acceptance | N/A until backend work lands. |
| Tests | N/A. |
| Risks | N/A. |
...
| Backend dependencies | **`docs/project/implementation-backlog.md` P2-014 (CSV export) — not implemented.** Do not start this task before it ships. |
| Acceptance | N/A until backend work lands. |
| Tests | N/A. |
| Risks | N/A. |
...
| Backend dependencies | **`docs/project/implementation-backlog.md` P4-007–P4-010 — none implemented.** `PlanPolicyService` is an intentional stub today; do not build a UI against a stub. |
| Acceptance | N/A until backend work lands. |
| Tests | N/A. |
| Risks | N/A. |
