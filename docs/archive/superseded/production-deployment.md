...
scaling with a sized pool. See `docs/operations/runbooks/production-runtime.md` for Gunicorn
...
See `docs/architecture/redis-production-contract.md` for HA expectations, feature-level
...
`REMOTE_APP_DIR`. See `docs/operations/runbooks/production-runtime.md` for reverse-proxy
